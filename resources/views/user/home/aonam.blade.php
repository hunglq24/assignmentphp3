        ...
        <div class="row">
          <div class="col-12">
            <div class="page-header-content">
              <h2 class="title" data-aos="fade-down" data-aos-duration="1000">Áo Nam</h2>
                            ...
                            <div class="product-item">
                              <div class="inner-content">
                                <div class="product-thumb">
                                  <a href="chitiet">
                                    <img src="{{$value->image}}" width="270" height="274" alt="Image-HasTech">
                                  </a>
                                ...
                                <div class="product-info">
                                  ...
                                  <h4 class="title"><a href="single-product.html">{{$value->name_product}}</a></h4>
                                  <div class="prices">
